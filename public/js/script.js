...
const toggleVisibility = (elementId) => {
    ...
    if (currentVisibility === "hidden") toggledVisibility = "visible";
    else toggledVisibility = "hidden";
...
addUniversityButton.addEventListener("click", async () => {
    ...
    const url = "http://127.0.0.1:8000/add-university";
    const body = {
        name: universityName,
        grade: grade,
    };
...
addTechnologyButton.addEventListener("click", async () => {
    ...
    const url = "http://127.0.0.1:8000/add-technology";
    const body = {
        name: technologyName,
    };
